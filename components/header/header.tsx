...
const Header = () => {
	...
	return (
		<header className='flex lg:flex-col justify-between lg:justify-start items-center bg-blueTertiary mb-6 lg:m-0 md:mx-8 md:mt-8 md:mb-8 lg:px-7 lg:py-9 p-4 md:p-6 rounded-[10px] md:rounded-[20px] lg:h-[92vh]'>
